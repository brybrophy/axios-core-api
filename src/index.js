...
var ApiCore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        return [2 /*return*/, this._handleErrors(error_1)];
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    ApiCore.prototype.get = function (url, params) {
        return __awaiter(this, void 0, void 0, function () {
            var res, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._AXIOS.get(url, { params: params })];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res.data];
                    case 2:
                        error_2 = _a.sent();
                        return [2 /*return*/, this._handleErrors(error_2)];
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    ApiCore.prototype.patch = function (url, data) {
        return __awaiter(this, void 0, void 0, function () {
            var res, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._AXIOS.patch(url, data)];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res.data];
                    case 2:
                        error_3 = _a.sent();
                        return [2 /*return*/, this._handleErrors(error_3)];
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    ApiCore.prototype.post = function (url, data) {
        return __awaiter(this, void 0, void 0, function () {
            var res, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._AXIOS.post(url, data)];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res.data];
                    case 2:
                        error_4 = _a.sent();
                        return [2 /*return*/, this._handleErrors(error_4)];
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    ApiCore.prototype.postFormData = function (url, data) {
        return __awaiter(this, void 0, void 0, function () {
            var res, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._AXIOS_FORM.post(url, this._getFormData(data))];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res.data];
                    case 2:
                        error_5 = _a.sent();
                        return [2 /*return*/, this._handleErrors(error_5)];
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    ApiCore.prototype.put = function (url, data) {
        return __awaiter(this, void 0, void 0, function () {
            var res, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._AXIOS.put(url, data)];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res.data];
                    case 2:
                        error_6 = _a.sent();
                        return [2 /*return*/, this._handleErrors(error_6)];
                    case 3: return [2 /*return*/];
                }
            });
        });
    ...
    ApiCore.prototype._handleErrors = function (error) {
        if (error.response) {
